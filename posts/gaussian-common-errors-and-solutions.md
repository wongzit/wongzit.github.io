> Please use your browser’s **Search** function to quickly find what you need. Clicking an error message in the table will take you directly to its solution. Last updated: Apr 2, 2026.
...
|L1002|[Inaccurate quadrature in CalDSu](https://wongzit.github.io/gaussian-common-errors-and-solutions/#inaccurate-quadrature-in-caldsu)<br>[No func 3rd derivs](https://wongzit.github.io/gaussian-common-errors-and-solutions/#no-func-3rd-derivs)<br>[NIJ > Max2 in MMCore](https://wongzit.github.io/gaussian-common-errors-and-solutions/#nij--max2-in-mmcore)<br>[XXXXX words are not enough for AlAXAO](https://wongzit.github.io/gaussian-common-errors-and-solutions/#xxxxx-words-are-not-enough-for-alaxao)<br>[CPHF failed to converge in LinEq2](https://wongzit.github.io/gaussian-common-errors-and-solutions/#cphf-failed-to-converge-in-lineq2)|
...
```
 ...
 SCX= 1.58D+02 DXMaxT= 0.00D+00 SCLim= 0.00D+00 Fact= 0.00D+00
 RedCar/ORedCr failed for GTrans.
 Error termination via Lnk1e in l101.exe at Fri Nov 14 10:32:53 2025.
```

**Explanation**

This error sometimes occurs when running a `QST2` transition-state search and is typically caused by incorrect atom numbering or an internal program issue.

**Fixing**

1.  Confirm that the reactant and product structures use the same atom numbering.
2.  If they do and the error persists, it may be due to a program bug. In that case, try an alternative method such as `QST3` or `Berny(TS)`.
...
As the error message explains, the CPHF process failed to converge. This error typically occurs during frequency analyses.

**Fixing**

Increase gird point using `cphf=grid=fine`.
