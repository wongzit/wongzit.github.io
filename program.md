...
- A **2D-ICSS input file generator**, released on **19th April 2021**. Supports **macOS**, **Linux** and **Microsoft Windows**.
- User manual, source code and executable files are free available from [GitHub page](https://github.com/wongzit/icssgen).
