...
<a href="https://www.codecogs.com/eqnedit.php?latex=\dpi{120}&space;\bg_white&space;{\rm&space;HOMA&space;}&space;=&space;1&space;-&space;\frac&space;{1}{n}&space;\sum^n_i&space;\alpha_j&space;\left(&space;R_{{\rm&space;opt,}j}&space;-&space;R_{i{\rm&space;,}j}&space;\right)^2{\color{Cyan}&space;}" target="_blank"><img src="https://latex.codecogs.com/png.latex?\dpi{120}&space;\bg_white&space;{\rm&space;HOMA&space;}&space;=&space;1&space;-&space;\frac&space;{1}{n}&space;\sum^n_i&space;\alpha_j&space;\left(&space;R_{{\rm&space;opt,}j}&space;-&space;R_{i{\rm&space;,}j}&space;\right)^2{\color{Cyan}&space;}" title="{\rm HOMA } = 1 - \frac {1}{n} \sum^n_i \alpha_j \left( R_{{\rm opt,}j} - R_{i{\rm ,}j} \right)^2{\color{Cyan} }" /></a>
