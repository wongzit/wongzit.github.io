...
(a) Use different optimization method: opt=RFO, opt=GDIIS, opt=GEDIIS.
(b) Use different coordinate system: opt=cartesian.
(c) Modify the symmetry.
(d) Try different DFT functionals or basis set.